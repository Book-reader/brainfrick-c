...
>>
    ...
    One last thing: an exclamation point is not a valid BF instruction(exclamationpoint)
    Print the newline
    [-]++++++++++.[-]
    [
        Oh, and now that I can use "(exclamationpoint)" the string you see should be one of:
        Hello World(exclamationpoint) 255
        Hello world(exclamationpoint) 65535
